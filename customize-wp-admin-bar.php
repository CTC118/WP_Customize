...
/* 
 * Removes the 28px margin for the Admin Bar. A disabled Admin Bar leave a 28px space at the top of the page, the snip below removes the extra space. The example removes the space for both the Admin Area and Websites.
 */  
...
/* 
 * Remove the WordPress Logo from the WordPress Admin Bar. This is the WP Logo displayed directly on the Admin Bar. 
 */  
...
/* 
 * Remove the Howdy menu from the WordPress Admin Bar. Disables the Howdy, Handle/Username menu on the main Admin Bar. 
 */  
